...
6. Go to `PassWizard-master\src\contexts\urlContext.js`
...
5. Go to `PassWizard-master\src\contexts\urlContext.js`
...
6. Seperate 'PassWizard-master' folder from main project folder to be deployed seperately as in the following guide
...
* Push `PassWizard-master` file to a new github repository and deploy it to heroku. Please follow the steps in the upmentioned guide and __note that here you don't need to change url in axios part as you did that on step 5__
